...
static int process_power_key_released(struct input_event *pinput)
{
	int ignore = false;
	unsigned int caps;
...
static int process_power_key_pressed(struct input_event *pinput)
{
	int ignore = false;
	unsigned int caps;
...
static int process_power_key_being_pressed(struct input_event *pinput)
{
...
static int check_key_filter_key(struct input_event *pinput, int fd)
{
	int ignore;
...
static int check_key_filter_rel(struct input_event *pinput, int fd)
{
...
static int check_key_filter_abs(struct input_event *pinput, int fd)
{
	int ignore = true;
...
static int check_key_filter_sw(struct input_event *pinput, int fd)
{
