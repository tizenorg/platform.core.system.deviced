...
static int mount_block_device(const char *devpath)
{
	struct block_data *data;
	pthread_t th;
	int r;
...
static int unmount_block_device(const char *devpath, enum unmount_operation option)
{
	struct block_data *data;
...
static int format_block_device(const char *devpath, enum unmount_operation option)
{
	struct block_data *data;
	struct unmount_data *udata;
	pthread_t th;
...
static int add_block_device(const char *devpath)
{
	return mount_block_device(devpath);
}

static int remove_block_device(const char *devpath)
{
	struct block_data *data;
	int r;
